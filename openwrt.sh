...
function install_bootstrap() {
  ...
  if [[ ${Anzhuang_shibai} == "1" ]]; then
    ...
    wget --tries=4 -q -P /tmp https://ghproxy.com/https://github.com/czkds/openwrt-package/blob/usb/zhuti/luci-theme-bootstrap_18.06.ipk -O /tmp/luci-theme-bootstrap.ipk
    if [[ $? -ne 0 ]]; then
...
function install_material() {
  ...
  if [[ ${Anzhuang_shibai} == "1" ]]; then
    ...
    wget --tries=4 -q -P /tmp https://ghproxy.com/https://github.com/czkds/openwrt-package/blob/usb/zhuti/luci-theme-material_21.02.ipk -O /tmp/luci-theme-material.ipk
    if [[ $? -ne 0 ]]; then
